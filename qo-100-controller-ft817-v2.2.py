...
UPLINK_LO_FREQUENCY = 196800000 - 30
...
# title bar
window.wm_title("FT-817 -- QO-100 Satellite Mode Controller.  @"+SERIAL_PORT+" : "+str(SERIAL_SPEED)+" Bd.  SatMode: "+satmode)
...
def set_bcn ():
    ...
    button_label_7.configure(command= calibrate, text = "CAL")
...
def read_frequency ():
    ...
    if read_ptt() is False:
        ...
        if setcal == False :
            button_label_7.config(text=COF)
...
# frequency label
label_4 = Label(window, font=('Arial', 30, 'bold'), width=13, fg='blue')
label_4.grid(column=1, row=1)

# function keys
button_label_7 = Button(window, command = set_bcn, width=6, highlightthickness=2, font=('Arial', 14, 'bold'))
...
Button(window, text = "525/CW",command = set_525,    width=5).grid(column=4, row=1)
Button(window, text = "540/DIG",command = set_540,   width=5).grid(column=5, row=1)
Button(window, text = "680/USB",command = set_680,   width=5).grid(column=6, row=1)
Button(window, text = "950/USB",command = set_950,   width=5).grid(column=7, row=1)
Button(window, text = "< 50", command = set_down_50, width=4).grid(column=8, row=1)
Button(window, text = "< 10", command = set_down_10, width=4).grid(column=9, row=1)
Button(window, text = "10 >", command = set_up_10,   width=4).grid(column=10, row=1)
Button(window, text = "50 >", command = set_up_50,   width=4).grid(column=11, row=1)

button_tune = Button(window, text = "Tune", command = start_tune, width=4, highlightthickness=2)
button_tune.grid(column=12, row=1)
